#!/bin/bash
# FB by: https://www.facebook.com/R.k.Riazkhan.termux.tool.owner
# Instagram: RED-MAFIA
#WATSAPP:https://chat.whatsapp.com/KmWJuOGRgVdHrDpMAFaOVi
trap 'store;exit 1' 2
...
printf "\e[1;92m _  | | RED-MAFIA (TEAM:RK AND ALI    \e[0m\n"
printf "\e[1;92m( \ | | ____    ___  _| |_  _____           \e[0m\n"
printf "\e[1;92m ) )| ||  _ \  /___)(_   _)(____ |  RED-MAFIA \e[0m\n"
printf "\e[1;77m(_/ | || | | ||___ |  | |_ / ___ |  _____   \e[0m\n"
printf "\e[1;77m    |_||_| |_|(___/    \__)\_____| (_____)  \e[0m\n"
printf "\e[1;77m🦋🦋🦋🆁🅴🅳-🅼🅰🅵🅸🅰-🆃🅴🅰🅼🦋🦋🦋 \e[0m\n"
printf "\e[1;77m\e[45m   Instagram Brute Forcer v1.5 Author: RED-MAFIA (Github/IG)   \e[0m\n"
printf "\e[1;77m❁❁❁❈❈❈❁❁𝐜𝐨𝐝𝐞𝐝 𝐛𝐲 𝐑𝐊(𝐀𝐋𝐈𝐑𝐀𝐙𝐀)❈❈❈❁❁ \e[0m\n"
}
